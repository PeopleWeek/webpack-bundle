...
/**
 * This class was copied from maba/dependency-injection-extra
 * maba/dependency-injection-extra is deprecated and this bundle (maba/webpack-bundle) uses only this class so it was
 * easier to just copy it over then to fork another repo
 */
